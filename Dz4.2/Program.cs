...
namespace Dz4._2
{
    ...
    {
        public virtual void Open() => Console.WriteLine("XMLHandler.Open");
        public virtual void Create() => Console.WriteLine("XMLHandler.Create");
        public virtual void Change() => Console.WriteLine("XMLHandler.Change");
        public virtual void Save() => Console.WriteLine("XMLHandler.Save");
    }
